# SA-DINO v3b: Tooth-Local Dense Attention
#
# Builds on SA-DINO v2 with:
# - Post-decoder tooth-local dense cross-attention
# - Each query attends to ALL encoder tokens within its tooth region
# - Provides much richer spatial context than deformable attention (4 pts)
# - Especially beneficial for small lesion localization
#
# Training:
#   CUDA_VISIBLE_DEVICES=2 bash projects/dental_dino/scripts/run_train.sh \
#     projects/dental_dino/configs/dino-4scale_r50_8xb2-24e_perio_sadino_v3b.py \
#     --work-dir work_dirs/dino-4scale_r50_8xb2-24e_perio_sadino_v3b
...
model = dict(
    ...
    aux_seg_upsample=2,
    # tooth-local dense attention (v3b) — no RoI refine here
